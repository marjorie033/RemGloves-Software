...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _showGestureGuideSheet(BuildContext context) {
    final gestures = [
      {'gesture': 'Open Palm',    'action': 'Turn ON Smart Light'},
      {'gesture': 'Closed Fist',  'action': 'Turn OFF Smart Light'},
      {'gesture': 'Thumbs Up',    'action': 'Increase Fan Speed'},
      {'gesture': 'Thumbs Down',  'action': 'Decrease Fan Speed'},
      {'gesture': 'Peace Sign',   'action': 'Turn ON TV'},
      {'gesture': 'Point Up',     'action': 'Volume Up'},
    ];
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => ListTile(
                  ...
                  title: Text(gestures[i]['gesture']!,
                      style: const TextStyle(
                          fontWeight: FontWeight.w600, fontSize: 13)),
                  subtitle: Text(gestures[i]['action']!,
                      style: const TextStyle(
